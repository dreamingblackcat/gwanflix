...
SELECT * FROM movies_v3  WHERE genres = "Romance" ORDER BY rating DESC;

-- Give me top 3 highly rated Sci-Fi movies in your store.
SELECT * FROM movies_v3  WHERE genres = "Romance" ORDER BY rating DESC LIMIT 3;
...
SELECT * FROM movies_v3 LIMIT 5;

-- Give me the second page of movies in your store.
SELECT * FROM movies_v3 LIMIT 5 OFFSET 5;

-- Give me the third page of movies in your store.
SELECT * FROM movies_v3 LIMIT 5 OFFSET 10;
